...
*/
var arr=[1,7,9,45];
var arr=["Str","alex","moh"];
var arr=['the','for','over','lazy','dog']
/*
2
...
3- Favorite Movie (4)
*/
var Favorite Food = ["mandi","aozi","Kosa","Magloba","Mansaf"]
var Favorite Sport= ["Football","KickBoxing","karatah"]
var Favorite Movie= ["Fast&fourios","Saw","the lord of the ring","Ring"]
/*
4
...
*/
function middleOfArray(mArray)
	
{
if (mArray.length%2==0)
	{
	return mArray[mArray.length/2-1] + " and " + mArray[mArray.length/2];}
else 
{return  mArray[(mArray.length-1)/2];}

}
var mArray =[1,2,3,4,5,6,7,8,9];
middleOfArray(mArray);
/*
9
...
**try more cases by your self
*/.
function removeFromArray(array,elemntR){
	for(i=0;i<array.length;i++){
	if (array[i]==elemntR){	
	array.splice(i,1);
	i=-1;
