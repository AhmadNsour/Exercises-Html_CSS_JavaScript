...
function stringItUp(arr){
  // your code here
  return arr.map(strr=>strr.toString());
}
console.log(stringItUp([2, 5, 100]));
/*
 * Exercise 3:  
...
function makeStrings(arr){
  // your code here
  arr.map(function(str1){
    if(str1.age >= 16){
      str1.name += " can go to The Matrix";
    }
    else{
      str1.name += " is under age!"
    }
  });
  arr = arr.map(str1=>str1.name)
  return arr;
}
/*
 * Exercise 6:  
